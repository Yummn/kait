...
{
    public const string Version="0.9.7-palm-kick";
    ...
    public static readonly List<KaitAbilityDef> Cards=new List<KaitAbilityDef>{
        ...
        P("M04",KaitPassive.DeflectMissiles,"拨挡飞弹","",1,"受到箭矢攻击时，消耗1气抵挡。","拨"),
        P("R08",KaitPassive.DistantPull,"水鞭","",1,"攻击方向上较远的敌人，造成1点伤害并拉至身前。","牵"),
        P("R09",KaitPassive.EndlessPush,"不坏气拳","",1,"拳击命中后，将存活敌人推至尽头。","远推"),
        A("E03",KaitSkill.ShapeIce,"塑造流水","",1,2,"在空格生成一根永久冰柱。","柱","Ice"),
        A("E04",KaitSkill.FrostBreath,"冬之吐息","",0,2,"对前方两格造成1点伤害，冻结存活敌人。","霜","Winter"),
        ...
        A("S01",KaitSkill.YummnShadowStep,"暗影步","",0,1,"传送至指定方向最近的空阴影格。","影","Shadow"),
        A("R17",KaitSkill.EchoStep,"影遁术","",1,2,"消耗指定方向的一个残影，传送至该格。","逐","Echo"),
        P("R19",KaitPassive.AllEchoWard,"暗影斗篷","",2,"残影可抵挡同一敌方回合内的所有攻击。","万"),
        A("S02",KaitSkill.Darkness,"黑暗术","",1,2,"在指定格生成永久黑雾，阻挡箭矢并禁止格内敌人攻击。","幕","Darkness"),
        ...
        P("R23",KaitPassive.KillSupply,"斗战冥想","",2,"自主移动不再补2；每次击杀补两个2。","杀2"),
        P("R24",KaitPassive.WaitSupply,"静谧心境","",1,"自主移动不再补2；每次等待补一个2。","候2"),
        P("O05",KaitPassive.Wholeness,"混元体","",2,"退出气竭时，恢复1点生命。","生"),
        A("R26",KaitSkill.MendWait,"疗伤冥想","",1,3,"恢复1点生命，随后推进敌方回合。","疗","Heal"),
        P("M05",KaitPassive.PerfectSelf,"完美自我","",0,"进入气竭时，恢复1气。","息"),
        P("R28",KaitPassive.DeepReservoir,"气海扩张","",1,"气上限+3；每次击杀恢复的气-1。","池"),
        P("O06",KaitPassive.QuiveringPalm,"震颤掌","",2,"拳击或踢击留下方向掌印；从其他方向命中时引爆，额外造成2点伤害。","印"),
        A("R30",KaitSkill.AirPalm,"空震","",1,2,"对指定方向首个敌人造成1点伤害，并推至尽头。","空","AirRay"),
        P("R31",KaitPassive.Passwall,"穿墙术","",1,"副盘数字可以穿过柱子。","穿"),
        ...
        P("R37",KaitPassive.KiAegis,"灵体护身","",2,"高速受击时，消耗3气抵挡；每次击杀恢复的气-1。","御"),
        ...
        A("N02",KaitSkill.ThunderWave,"雷鸣波","",0,2,"将四邻敌人向外推开1格。","震退","Thunder"),
        ...
        A("N06",KaitSkill.CommandAct,"命令术·出手","",1,2,"令指定敌人立即行动一次。","出手","CommandAct"),
    ...
    public static string TargetHint(KaitSkill s)=>s==KaitSkill.Darkness?"点击主棋盘任意格释放":s==KaitSkill.MageHand?"点击右侧副盘数字":s==KaitSkill.CommandAct?"点击一个敌人":s==KaitSkill.ShatterWave?"点击目标格及四邻范围":TargetsSelf(s)?"点击Yummn自身释放":TargetsGround(s)?"点击空目标格释放":"点选人物四周的方向释放";
