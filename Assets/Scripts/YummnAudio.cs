...
public sealed class YummnAudio : MonoBehaviour
{
    ...
    public static AudioClip LoadClip(string name)
    {
        ...
        return Resources.Load<AudioClip>("Audio/Yummn/Priority/" + name)
            ?? Resources.Load<AudioClip>("Audio/Yummn/SelectedModel/" + name)
    ...
    public static float CueVolume(string name) => name == "PalmSeal" ? 1.25f : name=="StoneCollision"?.92f:1f;
