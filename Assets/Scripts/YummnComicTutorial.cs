...
public static class YummnComicTutorial
{
    ...
    public static string Appendix(YummnRulesSnapshot r)
    {
        ...
        s.AppendLine("点击主动牌展开并准备释放，再点击目标：方向技能点人物四周；疗伤冥想点自身；冰柱、诱饵点空格；黑暗术可选主棋盘任意格，包括人物或敌人所在格。施放不滑动副盘；选目标时方向输入不会移动人物。点击空白、再次点击卡牌或5秒未操作会取消。目标无效或气不足会提示释放失败并退出，不扣气、不推进回合。\n");
        s.AppendLine("冻结与震慑");
