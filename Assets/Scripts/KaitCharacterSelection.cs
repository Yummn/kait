...
public sealed class KaitCharacterSelection : MonoBehaviour
{
    ...
    public static string[] SaveKeys(KaitCharacter c)=>c==KaitCharacter.Reynard?new[]{KaitVersion.ReynardSaveKey}:c==KaitCharacter.Yummn?new[]{KaitVersion.YummnSaveKey,KaitVersion.YummnPreviousSaveKey}:new[]{"Kait.Run.Kait"};
