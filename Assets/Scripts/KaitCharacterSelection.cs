...
public sealed class KaitCharacterSelection : MonoBehaviour
{
    ...
    public static string[] SaveKeys(KaitCharacter c)=>c==KaitCharacter.Yummn?new[]{"Kait.Run.Yummn.0.8.2","Kait.Run.Yummn.0.8.1","Kait.Run.Yummn.0.8"}:new[]{"Kait.Run.Kait"};
