...
public sealed class YummnKiWisp : MonoBehaviour
{
    ...
    public static Sprite Skin(int index)
    {
        ...
        return sprites[Mathf.Clamp(index,0,3)];
    }
    ...
    public void Configure(GlobalStyleSplit split)
    {
        ...
        paintedEmpty.color=Color.white;
    ...
    {
        img.sprite=Skin(skin);img.type=Image.Type.Simple;img.preserveAspect=true;img.color=Color.white;img.raycastTarget=false;
